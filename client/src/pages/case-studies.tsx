...
export default function CaseStudies() {
  ...
  const mainCaseStudies = [
    {
      title: "Как избежать штрафов на 50 млн и превратить отходы в доходы",
      category: "Пищевая промышленность",
      description: "Лидер кофейного рынка Беларуси рисковал получить штрафы до 50 млн рублей из-за отсутствия экодокументов. За 90 дней мы создали полную систему с нуля и помогли зарабатывать на отходах 1,2 млн в год.",
      results: [
        "Избежали штрафов до 50 млн рублей и закрытия производства",
        "Превратили отходы в доходы — 1,2 млн рублей прибыли в год",
        "Получили все разрешения за 90 дней вместо года бюрократии",
        "100% защита от проверок — все документы в полном порядке",
      ],
