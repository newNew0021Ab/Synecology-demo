            ...
            {services.map((service, index) => (
              <GlassmorphicCard key={service.title} delay={index * 0.1} className="group hover:scale-105 hover:shadow-2xl transition-all duration-300 border border-sea-green/10 hover:border-sea-green/30">
                <div className="mb-4 md:mb-6">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-sea-green/20 rounded-xl flex items-center justify-center group-hover:bg-sea-green/30 transition-all duration-300 float-right ml-4 mb-2 shadow-lg">
                    <service.icon className="w-5 h-5 md:w-6 md:h-6 text-sea-green group-hover:text-white" />
                  </div>
