...
export default function Services() {
  ...
  const services = [
    {
      ...
      description: "Оценка и учет источников выбросов согласно ТКП 17.02-08-2012.",
      features: [
      ...
      tags: ["Инвентаризация", "Выбросы", "ТКП", "Минприроды", "Атмосферный воздух"],
      slug: "emissions-inventory"
    },
    {
      icon: Recycle,
      title: "Нормативы ПДВ",
      description: "Расчет и согласование нормативов выбросов согласно ТКП 17.02-08-2012.",
      features: [
      ...
      tags: ["НДВ", "Нормативы", "Разрешения", "ТКП", "Минприроды"],
      slug: "pdv-standards"
    },
    {
      icon: FileText,
      title: "Экологический паспорт",
      description: "Паспорт предприятия согласно ТКП 17.02-08-2012 и требованиям Минприроды.",
      features: [
        "Анализ экологического состояния",
        "Заполнение согласно ТКП 17.02-08-2012",
    ...
    },
    {
      icon: Droplets,
      title: "Паспорт ГОУ",
      description: "Паспорт газоочистной установки согласно ТКП 17.02-08-2012.",
      features: [
      ...
      tags: ["ГОУ", "Газоочистка", "Паспорт", "ТКП", "Оборудование"],
      slug: "gas-treatment-passport"
    },
    {
      icon: Trash2,
      title: "Инструкции по отходам",
      description: "Инструкции по обращению с отходами согласно ТКП 17.02-08-2012.",
      features: [
      ...
      tags: ["Отходы", "Инструкция", "ТКП", "Согласование", "ПОД"],
      slug: "waste-management-instructions"
    },
    {
      icon: ClipboardList,
      title: "Ведение журналов учета",
      description: "Ведение обязательной экологической отчетности согласно ТКП 17.02-08-2012.",
      features: [
      ...
      tags: ["Отчетность", "Журналы", "ПОД", "ТКП", "Учет"],
      slug: "environmental-journals"
    },
    {
      icon: FileText,
      title: "Экологическое сопровождение",
      description: "Комплексная поддержка предприятий по вопросам экологии и ТКП 17.02-08-2012.",
      features: [
      ...
      tags: ["Аутсорсинг", "Сопровождение", "Эколог", "ТКП", "Отчетность"],
      slug: "ecological-support"
    },
    {
      icon: Factory,
      title: "Экологический аудит",
      description: "Анализ соответствия деятельности предприятия ТКП 17.02-08-2012.",
      features: [
      ...
      tags: ["Аудит", "Анализ", "Проверка", "ТКП", "Минприроды"],
      slug: "environmental-analysis"
    },
    {
      icon: FileText,
      title: "Документация по инструктажам",
      description: "Разработка документов для экологических инструктажей согласно ТКП 17.02-08-2012.",
      features: [
      ...
      tags: ["Инструктажи", "ПЭК", "Документация", "ТКП", "ООС"],
      slug: "instruction-documentation"
    },
    {
      icon: ClipboardList,
      title: "Инструкции по ПЭК",
      description: "Разработка документов для производственного контроля согласно ТКП 17.02-08-2012.",
      features: [
      ...
      tags: ["ПЭК", "Контроль", "Мониторинг", "ТКП", "Наблюдения"],
  ...
  const popularTags = ["ТКП", "Минприроды", "Документация", "Отчетность", "ПЭК", "Нормативы"];
