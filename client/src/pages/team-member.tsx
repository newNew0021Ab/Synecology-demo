...
export default function TeamMember() {
  ...
  const teamMembers = {
    "egor-koryakin": {
      ...
      role: "Директор",
      quote: "Экологическая ответственность и инновационные решения — основа устойчивого развития. Реальные изменения возможны только через грамотное управление ресурсами, профессиональный подход и системную работу. Реальные изменения возможны только через грамотное управление ресурсами, профессиональный подход и системную работу.",
      ...
      approach: "Более 100 успешно реализованных проектов, повышение экологической эффективности предприятий-партнеров и вклад в устойчивое развитие региона.",
      keyProjects: [
        {
      ...
      articles: [
        {
          ...
          excerpt: "Получение экологического сертификата — это не альтруизм, а стратегический шаг для увеличения целевой аудитории и конкурентного преимущества.",
          date: "20.12.2024",
        ...
        },
        {
          ...
          excerpt: "Правильная организация системы обращения с отходами — это вопрос финансовой безопасности и защиты от штрафов до 40 000 рублей.",
          date: "18.12.2024",
          category: "Отходы",
        ...
        },
        {
          ...
          excerpt: "Разработка проекта нормативов допустимых выбросов — инструмент для экономии на экологическом налоге и защиты от штрафов.",
          date: "16.12.2024",
          category: "Выбросы",
