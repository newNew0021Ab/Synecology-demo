...
export default function Header() {
  ...
  return (
    <header className="fixed top-4 left-4 right-4 z-50 bg-white/90 backdrop-blur-lg border border-white/30 rounded-full shadow-lg">
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="lg:hidden bg-white/95 backdrop-blur-lg border-t border-white/30 rounded-b-3xl mt-2 shadow-lg"
          >
